...
export function GameMathCell({ cell }: GameMathCellProps): JSX.Element {
  return (
...
export function GameMathPlayerGrid({
  ...
  nextDropCols,
  isMe,
}: GameMathPlayerGridProps): JSX.Element {
...
export function GameMathPlayer({ player, isMe }: GameMathPlayerProps): JSX.Element {
  return (
    <>
      <p>
        {player.username}
...
export function GameMath({ username, state, onGuess }: GameMathProps): JSX.Element {
  return (
    <>
      <p>Game Math</p>
